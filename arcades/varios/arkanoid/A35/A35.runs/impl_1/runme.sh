...
HD_PWD='F:/repos/a35/NUEVO/arkanoid/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arkanoid_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arkanoid_top.tcl -notrace
