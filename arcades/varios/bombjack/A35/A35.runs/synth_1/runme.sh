...
HD_PWD='F:/repos/a35/NUEVO/bombjack/A35/A35.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bombjack_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bombjack_top.tcl
