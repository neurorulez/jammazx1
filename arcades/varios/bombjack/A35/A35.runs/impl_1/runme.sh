...
HD_PWD='F:/repos/a35/NUEVO/bombjack/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bombjack_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bombjack_top.tcl -notrace
