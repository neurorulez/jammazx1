...
HD_PWD='F:/repos/a35/NUEVO/xevious/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xevious_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xevious_top.tcl -notrace
