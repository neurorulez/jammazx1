...
HD_PWD='F:/repos/a35/NUEVO/mpatrol/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mpatrol_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mpatrol_top.tcl -notrace
