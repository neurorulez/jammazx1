...
copy /b/y %rom_path_src%\v1.bin + %rom_path_src%\v2.bin + %rom_path_src%\v3.bin + %rom_path_src%\v4.bin + %rom_path_src%\v5.bin %rom_path%\main.bin

REM generate RTL code for small PROMS
REM %romgen_path%\romgen %rom_path_src%\6l.bpr    GALAXIAN_6L  5 c     > %rom_path%\galaxian_6l.vhd
%romgen_path%\romgen %rom_path_src%\PROM.6L    GALAXIAN_6L  5 l r e     > %rom_path%\galaxian_6l.vhd
...
%romgen_path%\romgen %rom_path_src%\A4.1H    GALAXIAN_1H 11 l r e > %rom_path%\galaxian_1h.vhd
%romgen_path%\romgen %rom_path_src%\DF.1K    GALAXIAN_1K 11 l r e > %rom_path%\galaxian_1k.vhd
