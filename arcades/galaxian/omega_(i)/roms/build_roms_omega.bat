...
copy /b/y %rom_path_src%\omega1.bin + %rom_path_src%\omega2.bin + %rom_path_src%\omega3.bin + %rom_path_src%\omega4.bin + %rom_path_src%\omega5.bin + %rom_path_src%\omega6.bin %rom_path%\main.bin

REM generate RTL code for small PROMS
REM %romgen_path%\romgen %rom_path_src%\6l.bpr    GALAXIAN_6L  5 c     > %rom_path%\galaxian_6l.vhd
%romgen_path%\romgen %rom_path_src%\mmi6331-1j.86    GALAXIAN_6L  5 l r e     > %rom_path%\galaxian_6l.vhd
...
%romgen_path%\romgen %rom_path_src%\omega1h.bin    GALAXIAN_1H 11 l r e > %rom_path%\galaxian_1h.vhd
%romgen_path%\romgen %rom_path_src%\omega1k.bin    GALAXIAN_1K 11 l r e > %rom_path%\galaxian_1k.vhd
