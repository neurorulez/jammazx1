...
REM ROM_END
set rom_path_src=catacomb
set rom_path=..\source\roms
set romgen_path=romgen

REM concatenate consecutive ROM regions
copy /b/y %rom_path_src%\cat-gfx1 + %rom_path_src%\cat-gfx2 %rom_path%\gfx1.bin
copy /b/y %rom_path_src%\catacomb.u + %rom_path_src%\catacomb.v + %rom_path_src%\catacomb.w + %rom_path_src%\catacomb.y + %rom_path_src%\catacomb.y %rom_path%\main.bin
...
%romgen_path%\romgen %rom_path_src%\cat-gfx1    GALAXIAN_1H 11 l r e > %rom_path%\galaxian_1h.vhd
%romgen_path%\romgen %rom_path_src%\cat-gfx2    GALAXIAN_1K 11 l r e > %rom_path%\galaxian_1k.vhd
