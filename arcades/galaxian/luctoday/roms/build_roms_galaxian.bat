...
copy /b/y %rom_path_src%\zz_6.1h + %rom_path_src%\zz_5.1k %rom_path%\gfx1.bin
...
%romgen_path%\romgen %rom_path_src%\zz_6.1h    GALAXIAN_1H 11 l r e > %rom_path%\galaxian_1h.vhd
%romgen_path%\romgen %rom_path_src%\zz_5.1k    GALAXIAN_1K 11 l r e > %rom_path%\galaxian_1k.vhd
