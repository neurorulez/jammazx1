...
REM ROM_END
set rom_path_src=warofbug
set rom_path=..\source\roms
set romgen_path=romgen

REM concatenate consecutive ROM regions
copy /b/y %rom_path_src%\warofbug.1k + %rom_path_src%\warofbug.1j %rom_path%\gfx1.bin
copy /b/y %rom_path_src%\warofbug.u + %rom_path_src%\warofbug.v + %rom_path_src%\warofbug.w + %rom_path_src%\warofbug.y + %rom_path_src%\warofbug.z %rom_path%\main.bin

REM generate RTL code for small PROMS
REM %romgen_path%\romgen %rom_path_src%\6l.bpr    GALAXIAN_6L  5 c     > %rom_path%\galaxian_6l.vhd
%romgen_path%\romgen %rom_path_src%\warofbug.clr    GALAXIAN_6L  5 l r e     > %rom_path%\galaxian_6l.vhd
...
%romgen_path%\romgen %rom_path_src%\warofbug.1k    GALAXIAN_1H 11 l r e > %rom_path%\galaxian_1h.vhd
%romgen_path%\romgen %rom_path_src%\warofbug.1j    GALAXIAN_1K 11 l r e > %rom_path%\galaxian_1k.vhd
