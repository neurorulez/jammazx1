...
copy /b/y %rom_path_src%\pgm.1 + %rom_path_src%\pgm.2 + %rom_path_src%\pgm.3 %rom_path%\main.bin
...
%romgen_path%\romgen %rom_path_src%\gfx.1    GALAXIAN_1H 11 l r e > %rom_path%\galaxian_1h.vhd
%romgen_path%\romgen %rom_path_src%\gfx.2    GALAXIAN_1K 11 l r e > %rom_path%\galaxian_1k.vhd
