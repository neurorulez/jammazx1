...
REM ROM_END
set rom_path_src=uniwars
set rom_path=..\source\roms
set romgen_path=romgen

REM concatenate consecutive ROM regions
REM 1j.bin=0x0000-0x0FFF
copy /b/y %rom_path_src%\egg10 + %rom_path_src%\h01_2.bin %rom_path_src%\1j.bin
REM 1k.bin=0x1000-0x1FFF
copy /b/y %rom_path_src%\egg9 + %rom_path_src%\k01_2.bin %rom_path_src%\1k.bin
REM main CPU 
copy /b/y %rom_path_src%\f07_1a.bin + %rom_path_src%\h07_2a.bin + %rom_path_src%\k07_3a.bin + %rom_path_src%\m07_4a.bin + %rom_path_src%\d08p_5a.bin + %rom_path_src%\gg6 + %rom_path_src%\m08p_7a.bin + %rom_path_src%\n08p_8a.bin %rom_path%\main.bin

REM generate RTL code for small PROMS
REM %romgen_path%\romgen %rom_path_src%\6l.bpr    GALAXIAN_6L  5 c     > %rom_path%\galaxian_6l.vhd
%romgen_path%\romgen %rom_path_src%\uniwars.clr    GALAXIAN_6L  5 l r e     > %rom_path%\galaxian_6l.vhd
