...
copy /b/y %rom_path_src%\ali1 + %rom_path_src%\ali2 + %rom_path_src%\ali3 +%rom_path_src%\ali4 + %rom_path_src%\ali5 + %rom_path_src%\ali6 + %rom_path_src%\ali7 + %rom_path_src%\ali8 + %rom_path_src%\ali9 + %rom_path_src%\ali10 + %rom_path_src%\ali11 %rom_path%\main.bin
...
%romgen_path%\romgen %rom_path_src%\ali13.1h    GALAXIAN_1H 11 l r e > %rom_path%\galaxian_1h.vhd
%romgen_path%\romgen %rom_path_src%\ali12.1k    GALAXIAN_1K 11 l r e > %rom_path%\galaxian_1k.vhd
