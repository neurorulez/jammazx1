...
HD_PWD='F:/repos/a35/NUEVO/bwidow/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bwidow_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bwidow_top.tcl -notrace
