...
HD_PWD='F:/repos/a35/NUEVO/pleiads/a35/a35.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pleiads_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pleiads_top.tcl
