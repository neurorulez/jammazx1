...
HD_PWD='F:/repos/a35/NUEVO/pleiads/a35/a35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pleiads_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pleiads_top.tcl -notrace
