...
copy /b/y %rom_path_src%\tpa + %rom_path_src%\tpc + %rom_path_src%\tpb + %rom_path_src%\tpd %rom_path%\gfx1.bin
copy /b/y %rom_path_src%\tp1 + %rom_path_src%\tp5a + %rom_path_src%\tp2 + %rom_path_src%\tp6 + %rom_path_src%\tp3 + %rom_path_src%\tp7 + %rom_path_src%\tp4 + %rom_path_src%\tp8 %rom_path%\main.bin
...
REM %romgen_path%\romgen %rom_path_src%\2s140.4a      PROM4_DST 8 c     > %rom_path%\prom4_dst.vhd
