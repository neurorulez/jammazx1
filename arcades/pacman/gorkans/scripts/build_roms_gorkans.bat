...
copy /b/y %rom_path_src%\gorkgfx4.rom + %rom_path_src%\gorkgfx2.rom + %rom_path_src%\gorkgfx3.rom + %rom_path_src%\gorkgfx1.rom %rom_path%\gfx1.bin
copy /b/y %rom_path_src%\gorkans8.rom + %rom_path_src%\gorkans4.rom + %rom_path_src%\gorkans7.rom + %rom_path_src%\gorkans3.rom + %rom_path_src%\gorkans6.rom + %rom_path_src%\gorkans2.rom + %rom_path_src%\gorkans5.rom + %rom_path_src%\gorkans1.rom %rom_path%\main.bin 

REM generate RTL code for small PROMS
%romgen_path%\romgen %rom_path_src%\gorkprom.3    PROM1_DST  9 l r e   > %rom_path%\prom1_dst.vhd
