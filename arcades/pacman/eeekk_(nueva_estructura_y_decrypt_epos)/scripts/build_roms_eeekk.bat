...
set rom_path_src=..\roms\eeekk
set rom_path=..\build
set romgen_path=..\romgen_source

REM concatenate consecutive ROM regions
copy /b/y %rom_path_src%\5_e_eeekk_pg03094.5e + %rom_path_src%\5_f_eeekk_pg03094.5f  %rom_path%\gfx1.bin 
copy /b/y %rom_path_src%\u_2_eeekk_pg03094.u2 + %rom_path_src%\u_3_eeekk_pg03094.u3  %rom_path%\main.bin 
copy /b/y %rom_path_src%\u_2_eeekk_pg03094.u2 + %rom_path_src%\u_3_eeekk_pg03094.u3  %rom_path%\main2.bin 

REM generate RTL code for small PROMS
%romgen_path%\romgen %rom_path_src%\82s126.1m     PROM1_DST  9 l r e     > %rom_path%\prom1_dst.vhd
%romgen_path%\romgen %rom_path_src%\4_a_eeekk.4a     PROM4_DST  8 c     > %rom_path%\prom4_dst.vhd
%romgen_path%\romgen %rom_path_src%\7_f_eeekk.7f     PROM7_DST  4 c    > %rom_path%\prom7_dst.vhd
