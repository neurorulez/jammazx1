...
set rom_path_src=..\roms\dremshpr
set rom_path=..\build
set romgen_path=..\romgen_source

REM concatenate consecutive ROM regions
copy /b/y %rom_path_src%\red-20.18 + %rom_path_src%\red-21.19 %rom_path%\gfx1.bin 
copy /b/y %rom_path_src%\red_1.50 + %rom_path_src%\red_2.51 + %rom_path_src%\red_3.52 + %rom_path_src%\red_4.53 %rom_path%\main.bin 
copy /b/y %rom_path_src%\red_5.39 + %rom_path_src%\red_6.40 + %rom_path_src%\red_7.41 + %rom_path_src%\red_7.41 %rom_path%\main1.bin 
