...
set rom_path_src=..\roms\jumpshotp
set rom_path=..\build
set romgen_path=..\romgen_source

REM concatenate consecutive ROM regions
copy /b/y %rom_path_src%\5e + %rom_path_src%\5f %rom_path%\gfx1.bin 
copy /b/y %rom_path_src%\js6e.bin + %rom_path_src%\js6f.bin + %rom_path_src%\js6h.bin + %rom_path_src%\js6j.bin %rom_path%\main.bin 

REM generate RTL code for small PROMS
%romgen_path%\romgen %rom_path_src%\82s126.1m     PROM1_DST  9 l r e     > %rom_path%\prom1_dst.vhd
%romgen_path%\romgen %rom_path_src%\prom.4a     PROM4_DST  8 c     > %rom_path%\prom4_dst.vhd
%romgen_path%\romgen %rom_path_src%\prom.7f     PROM7_DST  4 c    > %rom_path%\prom7_dst.vhd
...
%romgen_path%\romgen %rom_path%\main.bin          ROM_PGM_0 14 l r e -ini:.\jumpshotp_decrypt_cpu.ini > %rom_path%\rom0.vhd
