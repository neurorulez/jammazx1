...
set rom_path_src=..\roms\jumpshot
set rom_path=..\build
set romgen_path=..\romgen_source

REM concatenate consecutive ROM regions
copy /b/y %rom_path_src%\5e + %rom_path_src%\5f %rom_path%\gfx1.bin 
copy /b/y %rom_path_src%\6e + %rom_path_src%\6f + %rom_path_src%\6h + %rom_path_src%\6j %rom_path%\main.bin 
...
%romgen_path%\romgen %rom_path%\main.bin          ROM_PGM_0 14 l r e -ini:.\jumpshot_decrypt_cpu.ini > %rom_path%\rom0.vhd
