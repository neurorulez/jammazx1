...
set rom_path_src=..\roms\birdiy
set rom_path=..\build
set romgen_path=romgen_source

REM concatenate consecutive ROM regions
copy /b/y %rom_path_src%\c1.1c + %rom_path_src%\c3.3c %rom_path%\gfx1.bin
copy /b/y %rom_path_src%\a6.6a + %rom_path_src%\c6.6c + %rom_path_src%\a4.4a + %rom_path_src%\c4.4c %rom_path%\main.bin 

REM generate RTL code for small PROMS
%romgen_path%\romgen %rom_path_src%\n82s129n.4k    PROM1_DST  8 l r e   > %rom_path%\prom1_dst.vhd
%romgen_path%\romgen %rom_path_src%\n82s129n.9m    PROM4_DST  8 c   > %rom_path%\prom4_dst.vhd
%romgen_path%\romgen %rom_path_src%\n82s123n.10n    PROM7_DST  5 c   > %rom_path%\prom7_dst.vhd
...
rem %romgen_path%\romgen %rom_path%\gfx1.bin          ROM_PGM_1 13 l r e > %rom_path%\rom1.vhd
