...
set rom_path_src=..\roms\acitya
set rom_path=..\build
set romgen_path=..\romgen_source

REM concatenate consecutive ROM regions
copy /b/y %rom_path_src%\aca_5e.bin + %rom_path_src%\aca_5e.bin  %rom_path%\gfx1.bin 
copy /b/y %rom_path_src%\aca_u2.bin + %rom_path_src%\aca_u3.bin  %rom_path%\main.bin 
copy /b/y %rom_path_src%\aca_u2.bin + %rom_path_src%\aca_u3.bin  %rom_path%\main2.bin 
