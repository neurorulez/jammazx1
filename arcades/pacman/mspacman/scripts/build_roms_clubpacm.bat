...
set rom_path_src=..\roms\mspacmab
set rom_path=..\build
set romgen_path=..\romgen_source

REM concatenate consecutive ROM regions
copy /b/y %rom_path_src%\boot5 + %rom_path_src%\boot6 %rom_path%\wiz.bin 
copy /b/y %rom_path_src%\5e + %rom_path_src%\5f %rom_path%\gfx1.bin 
copy /b/y %rom_path_src%\boot1 + %rom_path_src%\boot2 + %rom_path_src%\boot3 + %rom_path_src%\boot4 %rom_path%\main.bin 
...
REM %romgen_path%\romgen %rom_path_src%\4a.cpu        PROM4_DST  8 c     > %rom_path%\prom4_dst.vhd
REM %romgen_path%\romgen %rom_path_src%\7f.cpu        PROM7_DST  4 c     > %rom_path%\prom7_dst.vhd
