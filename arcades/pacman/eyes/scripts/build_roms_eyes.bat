...
set rom_path_src=..\roms\eyeszacb
set rom_path=..\build
set romgen_path=..\romgen_source

REM concatenate consecutive ROM regions
copy /b/y %rom_path_src%\x.bin + %rom_path_src%\c.bin + %rom_path_src%\b.bin + %rom_path_src%\p.bin %rom_path%\gfx1.bin 
copy /b/y %rom_path_src%\zacb_1.bin + %rom_path_src%\zacb_5.bin + %rom_path_src%\zacb_2.bin + %rom_path_src%\zacb_6.bin + %rom_path_src%\zacb_3.bin + %rom_path_src%\zacb_7.bin + %rom_path_src%\zacb_4.bin + %rom_path_src%\zacb_8.bin %rom_path%\main.bin 

REM generate RTL code for small PROMS
%romgen_path%\romgen %rom_path_src%\82s126.1m     PROM1_DST  9 l r e     > %rom_path%\prom1_dst.vhd
%romgen_path%\romgen %rom_path_src%\82s129.4a     PROM4_DST  8 c     > %rom_path%\prom4_dst.vhd
