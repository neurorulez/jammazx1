...
set rom_path_src=..\roms\eggor
set rom_path=..\build
set romgen_path=..\romgen_source

REM concatenate consecutive ROM regions
copy /b/y %rom_path_src%\9.bin + %rom_path_src%\11.bin + %rom_path_src%\10.bin + %rom_path_src%\12.bin %rom_path%\gfx1.bin
copy /b/y %rom_path_src%\1.bin + %rom_path_src%\5.bin + %rom_path_src%\2.bin + %rom_path_src%\6.bin + %rom_path_src%\3.bin + %rom_path_src%\7.bin + %rom_path_src%\4.bin + %rom_path_src%\8.bin %rom_path%\main.bin 
