...
HD_PWD='F:/repos/a35/NUEVO/colony7/A35/A35.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log colony7_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source colony7_top.tcl
