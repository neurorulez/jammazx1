...
HD_PWD='F:/repos/a35/NUEVO/colony7/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log colony7_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source colony7_top.tcl -notrace
