...
HD_PWD='F:/repos/a35/NUEVO/robotron/A35/A35.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log robotron_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source robotron_top.tcl
