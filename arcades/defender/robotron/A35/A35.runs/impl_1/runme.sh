...
HD_PWD='F:/repos/a35/NUEVO/robotron/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log robotron_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source robotron_top.tcl -notrace
