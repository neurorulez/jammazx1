...
HD_PWD='F:/jammaZX1/arcades/defender/mayday/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mayday_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mayday_top.tcl -notrace
