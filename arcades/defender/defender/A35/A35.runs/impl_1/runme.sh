...
HD_PWD='F:/repos/a35/NUEVO/defender/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log defender_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source defender_top.tcl -notrace
