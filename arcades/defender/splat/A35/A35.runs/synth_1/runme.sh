...
HD_PWD='F:/repos/a35/NUEVO/splat/A35/A35.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log splat_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source splat_top.tcl
