...
HD_PWD='F:/repos/a35/NUEVO/splat/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log splat_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source splat_top.tcl -notrace
