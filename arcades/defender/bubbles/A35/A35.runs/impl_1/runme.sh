...
HD_PWD='F:/repos/a35/NUEVO/bubbles/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bubbles_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bubbles_top.tcl -notrace
