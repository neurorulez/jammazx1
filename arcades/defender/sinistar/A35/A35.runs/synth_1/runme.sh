...
HD_PWD='F:/jammaZX1/arcades/defender/sinistar/A35/A35.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sinistar_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sinistar_top.tcl
