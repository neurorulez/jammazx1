...
HD_PWD='F:/jammaZX1/arcades/defender/sinistar/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sinistar_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sinistar_top.tcl -notrace
