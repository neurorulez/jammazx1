...
HD_PWD='D:/repos/jammazx1 - Bigbucket/jammazx1/arcades/defender/joust/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log joust_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source joust_top.tcl -notrace
