...
HD_PWD='D:/repos/jammazx1 - Bigbucket/jammazx1/arcades/defender/joust/A35/A35.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log joust_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source joust_top.tcl
