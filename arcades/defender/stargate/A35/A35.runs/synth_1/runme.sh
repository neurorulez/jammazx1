...
HD_PWD='F:/repos/a35/NUEVO/stargate/A35/A35.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stargate_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stargate_top.tcl
