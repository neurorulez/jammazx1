...
HD_PWD='F:/repos/a35/NUEVO/stargate/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stargate_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stargate_top.tcl -notrace
