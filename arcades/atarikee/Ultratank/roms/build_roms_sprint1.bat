...
%romgen_path%\romgen %rom_path_src%\6442-01.d1   prog_rom3  11 l r > %rom_path%\prog_rom3.vhd
%romgen_path%\romgen %rom_path_src%\6443-01.e1   prog_rom4  11 l r > %rom_path%\prog_rom4.vhd
