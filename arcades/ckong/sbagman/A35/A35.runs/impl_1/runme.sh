...
HD_PWD='F:/repos/a35/NUEVO/bagman/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bagman_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bagman_top.tcl -notrace
