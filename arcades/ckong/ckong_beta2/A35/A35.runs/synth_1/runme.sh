...
HD_PWD='F:/jammaZX1/-hw ckong/ckong/A35/A35.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ckong_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ckong_top.tcl
