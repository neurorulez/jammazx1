...
HD_PWD='F:/jammaZX1/-hw ckong/ckong/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ckong_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ckong_top.tcl -notrace
