...
romgen bin\cpu0_rom    cpu0_rom   14 l r  > cpu0_rom.vhd
romgen bin\spchip_rom  spchip_rom 14 l r  > spchip_rom.vhd
romgen bin\cpu1_rom    cpu1_rom   13 l r  > cpu1_rom.vhd
romgen bin\cpu2_rom    cpu2_rom   12 l r  > cpu2_rom.vhd
romgen bin\bgscrn_rom  bgscrn_rom 12 l r  > bgscrn_rom.vhd
romgen bin\bgchip_rom  bgchip_rom 12 l r  > bgchip_rom.vhd
romgen bin\fgchip_rom  fgchip_rom 11 l r  > fgchip_rom.vhd
romgen bin\wave_rom    wave_rom    8 l r  > wave_rom.vhd
romgen bin\spclut_rom  spclut_rom  8 l r  > spclut_rom.vhd
romgen bin\bgclut_rom  bgclut_rom  8 l r  > bgclut_rom.vhd
romgen bin\palette_rom palette_rom 5 l r  > palette_rom.vhd
