...
set rom_path_src=amidar
set rom_path=..\source\roms
set romgen_path=romgen

REM concatenate consecutive ROM regions
copy /b %rom_path_src%\1.2c + %rom_path_src%\2.2e + %rom_path_src%\3.2f + %rom_path_src%\4.2h + %rom_path_src%\5.2j %rom_path%\rom.bin > NUL
...
%romgen_path%\romgen %rom_path_src%\c2.5f            ROM_OBJ_0 11 l r e > %rom_path%\ROM_OBJ_0.vhd
%romgen_path%\romgen %rom_path_src%\c2.5d            ROM_OBJ_1 11 l r e > %rom_path%\ROM_OBJ_1.vhd
