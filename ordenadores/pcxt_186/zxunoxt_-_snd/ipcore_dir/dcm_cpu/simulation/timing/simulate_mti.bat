...
vlog -work work dcm_cpu_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax dcm_cpu_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.dcm_cpu_tb work.glbl
