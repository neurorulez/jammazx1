...
xst -ifn xst.scr
move pll50_to_33_and_18_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll50_to_33_and_18_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll50_to_33_and_18_exdes.ucf pll50_to_33_and_18_exdes

echo 'Running map'
map -timing -pr b pll50_to_33_and_18_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pll50_to_33_and_18_exdes -w routed.ncd routed.v
cd ..
