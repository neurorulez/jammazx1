...
HD_PWD='F:/repos/a35/NUEVO/comodore64_beta_7/A35/A35.runs/relojes_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log relojes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source relojes.tcl
