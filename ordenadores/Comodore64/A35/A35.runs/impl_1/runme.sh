...
HD_PWD='F:/repos/a35/NUEVO/comodore64_beta_7/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log c64_zx3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source c64_zx3.tcl -notrace
