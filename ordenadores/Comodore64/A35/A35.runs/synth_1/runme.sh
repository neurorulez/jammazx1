...
HD_PWD='F:/repos/a35/NUEVO/comodore64_beta_7/A35/A35.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c64_zx3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c64_zx3.tcl
