...
HD_PWD='F:/repos/a35/NUEVO/llander/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log llander_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source llander_top.tcl -notrace
