...
HD_PWD='F:/repos/a35/NUEVO/asteroids/A35/A35.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log asteroids_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source asteroids_top.tcl -notrace
